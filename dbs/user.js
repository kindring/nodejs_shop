...
const car=require('./user_shoppingcar_db.js');
...
exports.add_car=car.add;
exports.user_car=car.user_find;
exports.del_car=car.del;
exports.change_car=car.change;

//测试用例
// exports.user_car(72261,0,10,function(err,result){
//     if(err){
